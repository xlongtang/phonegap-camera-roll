...
CameraRoll.prototype.find = function (max, startTime, successCallback, errorCallback) {
    if (typeof errorCallback != "function") {
    ...
    cordova.exec(successCallback, errorCallback, "CameraRoll", "find", [max, startTime]);
};
